...
class Task(LightningModule):
    ...
    def add_model_specific_args(parent_parser):
        ...
        parser.add_argument("--save_dir", type=str, default='exp/exp1')
        ...
        parser.add_argument("--train_csv_path", type=str, default="lists/train.csv")
        parser.add_argument("--trial_path", type=str, default="lists/vox1_test.txt")
